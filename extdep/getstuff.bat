...
REM set eth_server=https://build.ethdev.com/builds/windows-precompiled
set eth_server=https://github.com/ethereum/cpp-dependencies/releases/download/vc140


call :download boost 1.61
...
call :download OpenCL-ICD-loader 0.0
